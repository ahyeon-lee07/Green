	...
	<div class="container py-1">
                ...
                <div class="row">
                    ...
                    <div class="col-10 border border-left-0">
                        <div class="row text-center font-weight-bold p-2 border-bottom">
                            <div class="col">O-2021072220001</div>
                        </div>
		...
		<table class="table table-hover m-0 border-top">
			<thead class=" border-bottom-0 bg-light">
				<tr>
					<th class="text-center border-bottom-0 border-top-0 px-2" style="width: 80px">
						이미지
					</th>
					<th class="text-center border-bottom-0 border-top-0 px-2" style="width: 200px">
						상품명 / 옵션
					</th>
					<th class="text-center border-bottom-0 border-top-0 px-2" style="width: 10px">
						수량
					</th>
					<th class="text-center border-bottom-0 border-top-0 px-2" style="width: 80px">
						구매금액
					</th>
					<th class="text-center border-bottom-0 border-top-0 px-2" style="width: 30px">
						적립금
					</th>
					<th class="text-center border-bottom-0 border-top-0 px-2" style="width: 30px">
						기타
			...
			<tbody class="border-bottom">
					<tr>
						<td class="text-center align-middle px-5">
							<img src="${contextPath}/resources/img/콩이 레드.png" class="img-thumbnail">
						...
						<td class="text-center align-middle px-2">
							<a class="" href="${contextPath }/addNewReview.do">
								<button type="button" class="btn btn-outline-success btn-sm">리뷰</button>
							</a>
						</td>
					<tr>
						<td class="text-center align-middle px-5">
							<img src="${contextPath}/resources/img/콩이 핑크.png" class="img-thumbnail">
							<!-- <img src="${contextPath}/resources/img/${list.p_group }/${list.imgURL }" class="img-thumbnail" alt="#"> -->
						</td>
						<td class="align-middle flex-column">
							<div class="font-weight-bold pb-1 bd-highlight">
     		...
     		<div class="col-12">
				<div class="justify-content-between">
					<div class="bd-highlight mr-3" style='float: right;'>
						<button type="button" class="btn btn-outline-danger mr-2">주문 취소</button>
